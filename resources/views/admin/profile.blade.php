                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <input class="form-control" type="text" value="{{$profileData->name}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <input class="form-control" type="email" value="{{$profileData->email}}">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="card border mb-0">
                                            ...
                                            <div class="card-body mb-0">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-lg-12 col-xl-12">
                                                            <input name="new_password_confirmation" id="new_password_confirmation" class="form-control" type="password" placeholder="Confirm Password">
                                                        </div>
                                                    </div>
    ...
    $(document).ready(function() {
        $('#image').change(function(e) {
            ...
            reader.onload = function(e) {
                $('#showImage').attr('src', e.target.result); // Gán ảnh vừa đọc vào thẻ img có id="showImage"
            }
            reader.readAsDataURL(e.target.files[0]); // Đọc file đầu tiên được chọn
        });
    });
</script>
