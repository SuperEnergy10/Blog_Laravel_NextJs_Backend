                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="myForm" action="{{ route('store.blog.post') }}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                            <label for="validationDefault01" class="form-label">Blog Description</label>                                <select name="blogcat_id" class="form-select" id="example-select">
                            ...
                            <div class="col-md-6">
                            <label for="validationDefault01" class="form-label">Blog Image</label>                                <input type="file" name="image" class="form-control" id="image">
                            </div>
