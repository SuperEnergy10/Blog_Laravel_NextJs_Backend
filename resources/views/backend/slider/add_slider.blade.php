                    ...
                    <div class="card-body">
                        <form action="{{route('store.slider')}}" method="post" class="row g-3" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="heading" type="text" class="form-control" id="heading" value="Mark" required="">
                            </div>


                            <div class="col-md-6">
                                <label for="link" class="form-label">Slider Link</label>
                                <input name="link" type="text" class="form-control" id="link" value="Mark" required="">
                            </div>
                            <div class="col-md-6">
                                <label for="description" class="form-label">Slider Description</label>
                                <input name="description" type="text" class="form-control" id="description" value="Mark" required="">
                            </div>
                            <div class="col-md-6">
